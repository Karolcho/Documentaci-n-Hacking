...
# Solución
Descargar los archivos dados, después solamente usar el .py para desencriptar la flag

- Primero es descargar los archivos que se nos dan, como se observa el .py es un encriptador y desencriptador, por lo que solamente lo usamos para desencriptar la flag y con eso la obtenemos

...
# Solución
Utilizar un decodificador de rail-fence y con ello obtener la flag

- Primero descargamos el archivo que se nos da, después solamente buscamos algún decodificador de rail-fence y alli introducimos el mensaje para obtener la flag

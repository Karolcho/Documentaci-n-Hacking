...
# Solución
Utilizar ctrl+f para conseguir la flag y descifrarla

- Primero descargamos el archivo que se nos da, después aplicamos un ctrl+f y ponemos que busque "{}", con ello por el formato que tiene la flag, podemos encontrarla y solamente le aplicamos un ROT13 para descifrarla

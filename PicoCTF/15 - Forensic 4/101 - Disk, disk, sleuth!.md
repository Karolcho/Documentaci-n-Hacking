...
# Solución
Descargar la imagen que se nos da, descomprimirla y después con strings obtener la flag

- Primero descargamos el archivo que se nos da y lo descomprimimos, después usamos el comando "strings dds1-alpine.flag.img | grep pico", para obtener la flag directamente filtrada
